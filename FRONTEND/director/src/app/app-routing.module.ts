...
const routes: Routes = [
  ...
  { path: 'personales', loadChildren: './personales/personales.module#PersonalesPageModule' },
  { path: 'tecnicos', loadChildren: './tecnicos/tecnicos.module#TecnicosPageModule' },
  { path: 'actitudinales', loadChildren: './actitudinales/actitudinales.module#ActitudinalesPageModule' },  { path: 'docente', loadChildren: './docente/docente.module#DocentePageModule' },
