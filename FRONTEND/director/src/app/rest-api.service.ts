...
export class RestApiService {
  ...
  // CRUD PARA TIPOS DE SANGRE
    ...
    getAspectosTecnicos(): Observable<any> {
      const url = `${apiUrl}getTipoAspectosTecnicos`;
      return this.http.get(url, httpOptions).pipe(
        map(this.extractData),
        catchError(this.handleError));
    }
    postDesempenioDocente(data): Observable<any> {
      const url = `${apiUrl}tecnico-docente`;
      return this.http.post(url, data, httpOptions)
        .pipe(
          catchError(this.handleError)
        );
    ...
    getDocentes(): Observable<any> {
      const url = `${apiUrl}docentes`;
      return this.http.get(url, httpOptions).pipe(
        map(this.extractData),
        catchError(this.handleError));
    }
    getAspectosActitudinales(): Observable<any> {
      const url = `${apiUrl}getAspectosActitudinales`;
      return this.http.get(url, httpOptions).pipe(
        map(this.extractData),
        catchError(this.handleError));
    }
